...
**Comparison backbone (`data/sector_annual.csv`) = Crunchbase annual totals, all 6 sectors.** One consistent "VC-backed startup" definition → sectors are comparable. Galaxy is kept as a labeled Web3 deep dive, NOT mixed into the annual backbone.
...
- **Defense** — Crunchbase News: "Defense Tech Funding Growth YIR 2024" (https://news.crunchbase.com/venture/defense-tech-funding-growth-yir-2024/) and "Sector Snapshot: Defense Tech Funding Hits Record High" (https://news.crunchbase.com/defense-tech/funding-hits-record-high-2025-snapshot/). FY: $2.6B (113) / $2.7B (100) / $3.0B (102) / **$7.7B (~100, 2025)** — all using Crunchbase's narrow "military/national security/law enforcement" defense-tech definition. Space startup data is intentionally excluded.
